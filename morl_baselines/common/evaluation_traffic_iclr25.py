...
def eval_mo(
    ...
    vec_return, disc_vec_return = np.zeros(16), np.zeros(16)
    gamma = 0.99 # not 1.0
    while not done:
        if render:
            env.render()
    ...
    wandb.log(
        {
            ...
            "eval/hypervolume4": hv[3],
            "eval/hypervolume5": hv[4],
            "eval/sparsity": sp,
            "eval/normalized_sparsity": norm_sp,
            "eval/num_filtered_pt": len(filtered_front),
            "eval/average_pairwise_distance": eum,
