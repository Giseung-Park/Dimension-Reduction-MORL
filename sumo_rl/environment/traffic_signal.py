...
class TrafficSignal:
    ...
    def _build_phases(self):
        ...
        self.sumo.trafficlight.setRedYellowGreenState(self.id, self.all_phases[0].state) # GGrrrrGGrrrr
        ### logic
        ...
        #           Phase(duration=60, state='rrrGGrrrrGGr', minDur=-1, maxDur=-1),
        #           Phase(duration=60, state='rrrrrGrrrrrG', minDur=-1, maxDur=-1),
        #           Phase(duration=4, state='yyrrrryyrrrr', minDur=-1, maxDur=-1),
        #           Phase(duration=4, state='yyrrrryyrrrr', minDur=-1, maxDur=-1),
        #           Phase(duration=4, state='yyrrrryyrrrr', minDur=-1, maxDur=-1),
        #           Phase(duration=4, state='rryrrrrryrrr', minDur=-1, maxDur=-1),
        #           Phase(duration=4, state='rryrrrrryrrr', minDur=-1, maxDur=-1),
        #           Phase(duration=4, state='rryrrrrryrrr', minDur=-1, maxDur=-1),
        #           Phase(duration=4, state='rrryyrrrryyr', minDur=-1, maxDur=-1),
        #           Phase(duration=4, state='rrryyrrrryyr', minDur=-1, maxDur=-1),
        #           Phase(duration=4, state='rrryyrrrryyr', minDur=-1, maxDur=-1),
        #           Phase(duration=4, state='rrrrryrrrrry', minDur=-1, maxDur=-1),
        #           Phase(duration=4, state='rrrrryrrrrry', minDur=-1, maxDur=-1),
        #           Phase(duration=4, state='rrrrryrrrrry', minDur=-1, maxDur=-1)], subParameter={})
    ...
    def _waiting_time_reward_per_lane(self): # 8d for 2-way intersection, 16d for big-intersection
